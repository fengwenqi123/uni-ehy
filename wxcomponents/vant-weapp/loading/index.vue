<template>
<uni-shadow-root class="vant-weapp-loading-index"><view :class="'van-loading '+(vertical ? 'van-loading--vertical' : '')">
  ...
  <view :style="'font-size: '+(textSizeWithUnit)+';'" :class="'van-loading__text '+(vertical ? 'van-loading__text--vertical' : '')">
    <slot></slot>
  </view>
