...
export function hydrology(province, city, pageNum, pageSize) {
	return fly.request('/environment/hydrology', {
		province,
		city,
		pageNum,
		pageSize
...
export function findByCity(province, city) {
	return fly.request('/environment/hydrology/findByCity', {
		province,
		city
	}, {
		method: 'GET'
...
export function shipInfo(cbsbh) {
	return fly.request('/collaboration/shipExtend/findByCbsbh', {
		cbsbh
	}, {
		method: 'GET'
	})
...
export function certificate(cbdjh) {
	return fly.request('/collaboration/certificateAllExtend/list', {
		cbdjh
	}, {
		method: 'GET'
	})
...
export function latestPosByShipName(dataType, shipName) {
	return fly.request('/gps/position/latestPosByShipName', {
		dataType,
		shipName
	}, {
		method: 'GET'
...
export function violation(pageNum, pageSize, shipName) {
	return fly.request('/collaboration/violation', {
		pageNum,
		pageSize,
		shipName
	}, {
